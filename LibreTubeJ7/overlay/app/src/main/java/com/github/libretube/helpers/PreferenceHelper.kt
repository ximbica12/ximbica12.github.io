...
object PreferenceHelper {
    ...
    fun reloadAuthenticationPreferences(context: Context = LibreTubeApp.instance) {
        authSettings = getAuthenticationPreferences(context)
    }
    ...
    private fun getAuthenticationPreferences(context: Context): SharedPreferences {
        ...
        val fileName = if (profileId == ProfileManager.DEFAULT_PROFILE_ID) {
            PreferenceKeys.AUTH_PREF_FILE
        } else {
            "${PreferenceKeys.AUTH_PREF_FILE}_$profileId"
        }
