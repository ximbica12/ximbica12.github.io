...
class SubscriptionsFragment : DynamicLayoutManagerFragment(R.layout.fragment_subscriptions) {
    ...
    private val channelAdapter = SubscriptionCircleAdapter()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.subscriptions.observe(viewLifecycleOwner) { subscriptions ->
            ...
            binding.subChannelsTitle.isVisible = channels.isNotEmpty()
            binding.subChannels.isVisible = channels.isNotEmpty()
            binding.subChannelsTitle.text = getString(
                R.string.your_channels_count,
                channels.size
            )
        }
