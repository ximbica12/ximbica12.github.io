        ...
        if (!LocaleHelper.isPerAppLocaleSettingSupported()) {
            ...
            val languages = requireContext().resources.getStringArray(R.array.languageCodes)
                .map { code ->
                    ...
                    // Store the resource qualifier itself. Using Locale.toString()
                    // turned pt-rBR into pt_BR, which the Android 8 parser did not
                    // understand and caused English fallback.
                    code to label
